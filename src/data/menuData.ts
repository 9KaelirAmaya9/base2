...
export const menuItems: MenuItem[] = [
  // Tacos
  { id: "t1", name: "Cochinita Pibil", description: "Slow-roasted pork marinated in citrus and achiote, tender and aromatic", price: 4.00, category: "Tacos", image: "/src/assets/menu/cochinita-pibil.jpg" },
  { id: "t2", name: "Birria", description: "Rich, slow-braised beef in savory chile broth, perfectly spiced", price: 3.00, category: "Tacos", image: "/src/assets/menu/birria-taco.jpg" },
  { id: "t3", name: "Al Pastor", description: "Juicy marinated pork with pineapple, grilled to perfection on the trompo", price: 3.00, category: "Tacos", image: "/src/assets/menu/al-pastor.jpg" },
  { id: "t4", name: "Tripa", description: "Crispy, golden-fried beef tripe with a satisfying crunch", price: 3.00, category: "Tacos" },
  { id: "t5", name: "Lengua", description: "Tender, melt-in-your-mouth beef tongue, seasoned to perfection", price: 5.00, category: "Tacos", image: "/src/assets/menu/lengua-taco.jpg" },
  { id: "t6", name: "Cabeza", description: "Succulent beef head meat, incredibly tender and flavorful", price: 4.00, category: "Tacos" },
  { id: "t7", name: "Carnitas", description: "Crispy-edged, melt-in-your-mouth fried pork, the ultimate comfort", price: 3.00, category: "Tacos", image: "/src/assets/menu/carnitas-taco.jpg" },
  ...
  { id: "t14", name: "Pollo Asado", description: "Smoky grilled chicken with char-kissed perfection", price: 3.00, category: "Tacos", image: "/src/assets/menu/pollo-asado-taco.jpg" },
  ...
  { id: "ts1", name: "Birria", description: "Rich braised beef on crispy tortilla with fresh toppings", price: 3.50, category: "Tostadas", image: "/src/assets/menu/birria-tostada.jpg" },
  ...
  { id: "ts11", name: "Tinga", description: "Smoky chipotle chicken in tomato sauce, absolutely addictive", price: 3.50, category: "Tostadas", image: "/src/assets/menu/tinga-tostada.jpg" },
  ...
  { id: "ts15", name: "De Camarones", description: "Plump shrimp with citrus and fresh vegetables", price: 4.50, category: "Tostadas", image: "/src/assets/menu/camarones-tostada.jpg" },
  ...
  { id: "to1", name: "Birria", description: "Rich braised beef on toasted telera roll with all the fixings", price: 9.00, category: "Tortas", image: "/src/assets/menu/torta-birria.jpg" },
  ...
  { id: "to10", name: "Cubana", description: "Loaded sandwich with multiple meats, cheese, and everything", price: 10.00, category: "Tortas", image: "/src/assets/menu/torta-cubana.jpg" },
  ...
  // Burritos
  { id: "b1", name: "Birria", description: "Rich braised beef with rice, beans, and melted cheese", price: 11.00, category: "Burritos", image: "/src/assets/menu/burrito-birria.jpg" },
  ...
  // Sopas (Soups)
  { id: "s1", name: "Pozole Chica", description: "Hearty hominy soup with tender pork in red chile broth", price: 7.00, category: "Sopas", image: "/src/assets/menu/pozole.jpg" },
  ...
  { id: "s5", name: "Caldo de Camaron", description: "Spicy shrimp soup with vegetables, bold and satisfying", price: 15.00, category: "Sopas", image: "/src/assets/menu/caldo-camaron.jpg" },
  ...
  { id: "p1", name: "Molcajete", description: "Sizzling volcanic stone bowl with grilled meats, nopales, and cheese", price: 29.00, category: "Platillos Principales", image: "/src/assets/menu/molcajete.jpg" },
  ...
  { id: "p4", name: "Ricos Chiles Rellenos", description: "Poblano peppers stuffed with cheese, in savory tomato sauce", price: 15.00, category: "Platillos Principales", image: "/src/assets/menu/chiles-rellenos.jpg" },
  ...
  { id: "p10", name: "Enchiladas Rojas", description: "Rolled tortillas in smoky red chile sauce with melted cheese", price: 14.00, category: "Platillos Principales", image: "/src/assets/menu/enchiladas-rojas.jpg" },
  ...
  { id: "p14", name: "Mojarra Frita", description: "Whole fried tilapia, crispy outside and tender inside", price: 14.99, category: "Platillos Principales", image: "/src/assets/menu/mojarra-frita.jpg" },
  ...
  { id: "p16", name: "Mole Poblano", description: "Chicken in rich chocolate-chile sauce, a Mexican classic", price: 14.99, category: "Platillos Principales", image: "/src/assets/menu/mole-poblano.jpg" },
  ...
  { id: "p20", name: "Camarones a la Diabla", description: "Shrimp in fiery red chile sauce, not for the faint of heart", price: 14.99, category: "Platillos Principales", image: "/src/assets/menu/camarones-diabla.jpg" },
  ...
  { id: "p24", name: "Arrachera", description: "Tender marinated skirt steak, grilled to juicy perfection", price: 18.00, category: "Platillos Principales", image: "/src/assets/menu/arrachera.jpg" },
  ...
  { id: "a3", name: "Quesadillas Regular", description: "Melted cheese in handmade tortilla, simple perfection", price: 7.00, category: "Antojitos", image: "/src/assets/menu/quesadilla.jpg" },
  ...
  { id: "a7", name: "Nachos", description: "Crispy chips loaded with cheese, meat, and fresh toppings", price: 13.00, category: "Antojitos", image: "/src/assets/menu/nachos.jpg" },
  ...
  { id: "d2", name: "Aguas Frescas Gde", description: "Large refreshing fruit water in seasonal flavors", price: 4.00, category: "Bebidas", image: "/src/assets/menu/aguas-frescas.jpg" },
  ...
  { id: "d15", name: "Jugo de Naranja", description: "Freshly squeezed orange juice, pure sunshine", price: 4.00, category: "Bebidas", image: "/src/assets/menu/jugo-naranja.jpg" },
  ...
  // Postres (Desserts)
  { id: "de1", name: "Pastel de Tres Leches", description: "Heavenly sponge cake soaked in three milks, incredibly moist", price: 5.00, category: "Postres", image: "/src/assets/menu/tres-leches.jpg" },
  { id: "de2", name: "Gelatinas", description: "Colorful layered gelatin desserts, light and refreshing", price: 3.00, category: "Postres" },
  { id: "de3", name: "Flan Napolitano", description: "Silky caramel custard, smooth and decadent", price: 4.00, category: "Postres", image: "/src/assets/menu/flan.jpg" },
