...
export const translations: Record<"en" | "es", Translations> = {
  en: {
    ...
    "location.checkDelivery": "Check Delivery Availability",
    "location.verifyDeliveryArea": "Verify Delivery Area",
    "location.checkDeliverySubtext": "Enter your address to see if we deliver to your area (20-minute delivery zone)",
  ...
  es: {
    ...
    "location.checkDelivery": "Verificar Disponibilidad de Entrega",
    "location.verifyDeliveryArea": "Verificar Zona de Entrega",
    "location.checkDeliverySubtext": "Ingresa tu dirección para ver si entregamos en tu área (zona de entrega de 20 minutos)",
